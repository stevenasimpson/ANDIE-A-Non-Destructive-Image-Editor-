...
public class ViewActions {
    ...
    public ViewActions() {
        ...
        actions.add(new ZoomInAction(I18n.getKeyString("zoomIn"), new ImageIcon(this.getClass().getClassLoader().getResource("zoomIn.png")), I18n.getKeyString("zoomInDesc"), Integer.valueOf(KeyEvent.VK_EQUALS)));
        actions.add(new ZoomOutAction(I18n.getKeyString("zoomOut"), new ImageIcon(this.getClass().getClassLoader().getResource("zoomOut.png")), I18n.getKeyString("zoomOutDesc"), Integer.valueOf(KeyEvent.VK_MINUS)));
        actions.add(new ZoomFullAction(I18n.getKeyString("zoomFull"), new ImageIcon(this.getClass().getClassLoader().getResource("zoomFull.png")), I18n.getKeyString("zoomFullDesc"), Integer.valueOf(KeyEvent.VK_0)));
    }
    ...
    public JMenu createMenu() {
        ...
        JMenu viewMenu = new JMenu(I18n.getKeyString("view"));
...
/**
    ...
    public ArrayList<JButton> createButtons(){
        ...
        options.add(0);//option for zoom in
        options.add(1);//option for zoom out
        options.add(2);//option for zoom full
